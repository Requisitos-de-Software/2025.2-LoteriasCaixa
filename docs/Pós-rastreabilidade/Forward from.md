...
| **RNF19** | O aplicativo apresenta uma falta de alerta para o usuário sobre uma aposta premiada que ainda não foi resgatada. | Não Implementado | [AD11](../Elicitação/Técnicas/Análise%20de%20Documentos.md) |
...
| **RNF21** | O aplicativo não apresenta uma forma de mostrar os resultados em tempo real. | Não Implementado | [AD14](../Elicitação/Técnicas/Análise%20de%20Documentos.md) |
...
| **RNF24** | O aplicativo é de uma fonte confiável para o usuário. | Implementado | [ENT17](../Elicitação/Técnicas/Entrevista.md) |
