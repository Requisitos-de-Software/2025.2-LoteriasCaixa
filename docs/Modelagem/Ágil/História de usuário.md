...
|Rastreabilidade| [#RF06](../../Pós-rastreabilidade/matriz_geral.md) |
|Prioridade| Baixa|
...
|Rastreabilidade| [#RF09](../../Pós-rastreabilidade/matriz_geral.md) |
|Prioridade| Alta|
...
|Rastreabilidade| [#RF07](../../Pós-rastreabilidade/matriz_geral.md) |
|Prioridade| Media|
...
|Rastreabilidade| [#RF12](../../Pós-rastreabilidade/matriz_geral.md) |
|Prioridade| Alta|
...
|Rastreabilidade| [#RF16](../../Pós-rastreabilidade/matriz_geral.md) |
|Prioridade| Media|
...
|Rastreabilidade| [#RF01](../../Pós-rastreabilidade/matriz_geral.md) |
|Prioridade| Alta|
...
| **Rastreabilidade** | [RNF06](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
...
| **Rastreabilidade** | [RF33](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF36](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF37](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Alta |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RNF07](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RNF08](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RNF02](../../Pós-rastreabilidade/matriz_geral.md#rnf02---o-software-deve-ter-imagens-explicativas) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF09](../../Pós-rastreabilidade/matriz_geral.md#rf09---deve-haver-uma-verificação-de-identidade-para-login-no-aplicativo) |
| **Prioridade** | Alta |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF15](../../Pós-rastreabilidade/matriz_geral.md#rf15---o-aplicativo-deve-exibir-os-tipos-de-loteria-disponíveis-mega-sena-lotofácil-etc) |
| **Prioridade** | Alta |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF05](../../Pós-rastreabilidade/matriz_geral.md#rf05---o-usuário-deve-poder-consultar-seus-ganhos) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF23](../../Pós-rastreabilidade/matriz_geral.md#rf23---o-aplicativo-deve-permitir-pagamento-de-apostas-utilizando-carteiras-digitais-como-google-pay-apple-pay-e-mercado-pago) |
| **Prioridade** | Alta |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF16](../../Pós-rastreabilidade/matriz_geral.md#rf16---o-aplicativo-deve-exibir-o-último-resultado-do-sorteio-de-cada-loteria) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF03](../../Pós-rastreabilidade/matriz_geral.md)|
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF28](../../Pós-rastreabilidade/matriz_geral.md)|
| **Prioridade** | Alta |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RNF10](../../Pós-rastreabilidade/matriz_geral.md)|
| **Prioridade** | Alta |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RFN09](../../Pós-rastreabilidade/matriz_geral.md)|
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF10](../../Pós-rastreabilidade/matriz_geral.md)|
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RNF31](../../Pós-rastreabilidade/matriz_geral.md)|
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF38](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Alta |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF39](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Alta |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RNF12](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RF40](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RNF32](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Baixa |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF41](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Critérios de Aceitação** | - Na tela "Minhas Apostas", cada aposta confirmada deve ter um ícone ou botão "Baixar Comprovante".<br>- Ao ser acionado, o aplicativo deve gerar um arquivo (PDF ou .png) com os detalhes da aposta (números, concurso, data, valor, código de autenticação).<br>- O sistema deve solicitar permissão para salvar o arquivo no dispositivo do usuário. |
| **Rastreabilidade** | [RNF20](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Alta |
| **Status** | Não Implementado |
...
| **Critérios de Aceitação** | - Todos os ícones na barra de navegação principal (ex: menu, início, apostas, carrinho) devem exibir um rótulo de texto descritivo abaixo deles.<br>- Os rótulos devem ser legíveis e ter contraste adequado, conforme as diretrizes de acessibilidade.<br>- Os rótulos devem ser autoexplicativos (ex: "Início", "Carrinho"). |
| **Rastreabilidade** | [RNF11](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Critérios de Aceitação** | - Ao selecionar uma modalidade de loteria, o aplicativo deve exibir um volante digital com todos os números disponíveis.<br>- O toque em um número deve marcá-lo visualmente (com cor e contraste distintos, conforme RNF06).<br>- Tocar em um número já marcado deve desmarcá-lo.<br>- O aplicativo deve impedir a seleção de mais números do que o permitido para uma aposta simples naquela modalidade. |
| **Rastreabilidade** | [RF17]((../../Pós-rastreabilidade/matriz_geral.md)), [RNF06](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Alta |
| **Status** | Implementado |
...
| **Critérios de Aceitação** | - Um botão "Completar" ou "Surpresinha" deve estar visível na tela do volante de aposta.<br>- Se nenhum número foi selecionado, o botão deve preencher a quantidade mínima de números para aquela modalidade.<br>- Se alguns números já foram selecionados, o botão deve preencher os números restantes até atingir a aposta mínima. |
| **Rastreabilidade** | [RF19](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Baixa |
| **Status** | Implementado |
...
| **Critérios de Aceitação** | - Após selecionar os números no volante, um botão "Adicionar ao Carrinho" deve estar disponível.<br>- Ao clicar, a aposta deve ser salva no carrinho e o usuário deve poder retornar para fazer novas apostas.<br>- O ícone do carrinho deve atualizar (feedback visual) indicando o número de itens. |
| **Rastreabilidade** | [RF20](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Alta |
| **Status** | Implementado |
...
| **Critérios de Aceitação** | - A tela contendo os números do último resultado de uma loteria deve ser totalmente carregada e exibida em menos de 3 segundos.<br>- O critério deve ser validado em uma conexão 4G/5G padrão.<br>- Um indicador de carregamento (spinner) deve ser exibido se a consulta levar mais de 1 segundo. |
| **Rastreabilidade** | [RNF04](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RNF16](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RNF21](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
| **Rastreabilidade** | [RF13](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Implementado |
...
| **Rastreabilidade** | [RNF23](../../Pós-rastreabilidade/matriz_geral.md) |
| **Prioridade** | Média |
| **Status** | Não Implementado |
...
|:--------:|:------------:|:---------------------:|:----------------------------------------------:|:---------:|
| ``1.0``    | 19/10/2025 | [Heyttor Augusto](https://github.com/H3ytt0r62)   | Criação da página historias de usuario, adição da introdução, metodologia e HU's de 1 a 6 | [Samuel Felipe](https://github.com/TerminaKng05) |
