...
O Backlog é formado por dois tipos de elementos: épicos e temas. Enquanto as histórias de usuário podem ser divididas em partes menores — de modo que cada uma possa ser facilmente integrada à arquitetura do software e desenvolvida dentro de uma iteração —, algumas solicitações dos usuários representam objetivos mais amplos e agregadores, conhecidos como épicos.Já os temas correspondem a grupos de histórias de usuário que possuem alguma relação entre si.
